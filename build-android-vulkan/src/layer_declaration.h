...
#include "layer/slicing.h"
namespace ncnn {
class Slicing_final : virtual public Slicing
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Slicing::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Slicing::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Slicing_final)
} // namespace ncnn
